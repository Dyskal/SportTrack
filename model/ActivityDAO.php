...
class ActivityDAO {
    ...
    public final function insert($st) {
        if ($st instanceof Activity) {
            ...
            $query = "Insert Into Activity(id, user_id, date, description, start_time, duration, freq_min, freq_max, freq_avg) Values (:id, :user_id, :date, :description, :start_time, :duration, :freq_min, :freq_max, :freq_avg)";
