...
router.post('/', asyncMiddleware(async (req, res, next) => {
    ...
    if (usr.length === 0) {
        if (req.body.email != null && req.body.password != null && req.body.lname != null && req.body.fname != null &&
            req.body.bdate != null && req.body.gender != null && req.body.height != null && req.body.weight != null) {
